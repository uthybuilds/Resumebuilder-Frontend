...
const Footer = () => {
  ...
  return (
    <>
      <footer className="flex flex-wrap justify-center lg:justify-between overflow-hidden gap-8 md:gap-16 py-14 px-4 sm:px-8 md:px-16 lg:px-24 xl:px-32 text-[13px] text-gray-500 bg-gradient-to-r from-white via-indigo-100/60 to-white mt-40">
        <div className="w-full grid grid-cols-2 sm:grid-cols-3 items-start gap-8 md:gap-[60px] xl:gap-[140px] lg:w-auto">
          <a
            href="#"
            className="col-span-2 sm:col-span-1 justify-self-center sm:justify-self-start"
          >
            <img src="/logo.svg" alt="logo" className="h-11 w-auto" />
          </a>
          <div className="min-w-[150px] justify-self-center text-center sm:text-left">
          ...
          <div className="min-w-[150px] justify-self-center text-center sm:text-left">
            ...
            <ul className="mt-2 space-y-2">
              ...
              <li>
                <a href="#guide" className="hover:text-indigo-600 transition">
                  Guide
                </a>
              </li>
              <li>
        ...
        <div className="flex flex-col max-sm:items-center max-sm:text-center gap-2 items-end w-full lg:w-auto">
          ...
          <p className="mt-3 text-center">© {year} Resume Builder</p>
        </div>
      </footer>{" "}
      <style>{`
