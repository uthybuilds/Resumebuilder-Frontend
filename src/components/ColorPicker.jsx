  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-1 text-sm text-indigo-600 bg-gradient-to-br from-indigo-50 to-indigo-100 ring-indigo-300 hover:ring transition-all px-3 py-2 rounded-lg"
      >
